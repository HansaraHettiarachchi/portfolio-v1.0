...
export default function Contact() {
  return (
  <section className="relative w-full py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
  ...
  <div className="mx-auto max-w-4xl">
        <div className="relative rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-[#0a0b2e]/50 backdrop-blur-sm shadow-md border border-purple-500/20 flex items-start gap-4 hover:scale-[1.01] hover:border-purple-500/40 transition-all">
              ...
              <div>
                ...
                <a className="" href="mailto:hansarasasanka@gmail.com">hansarasasanka@gmail.com</a>
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 text-sm text-slate-400">Tip: Hover the cards and buttons for subtle motion — swap the demo details above with your real content when ready.</div>
        </div>
        </div>
      </div>
